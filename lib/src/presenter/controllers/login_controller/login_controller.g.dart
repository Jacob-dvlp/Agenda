...
mixin _$LoginControllerApp on LoginController, Store {
  late final _$isLoadingAtom =
      Atom(name: 'LoginController.isLoading', context: context);
  ...
  @override
  Future<EntitieUserModel?> login(BuildContext context) {
  ...
  dynamic checkLogin(bool value) {
    final _$actionInfo = _$LoginControllerActionController.startAction(
        name: 'LoginController.checkLogin');
    try {
